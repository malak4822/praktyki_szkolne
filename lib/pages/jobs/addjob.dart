                    ...
                    child: Form(
                        ...
                        child: ListView(
                            ...
                            children: [
                              ...
                              const SizedBox(height: 16),
                              updateValues(jobPhone, 'Telefon', 1, 9,
                                  Icons.phone, TextInputType.phone),
                              const SizedBox(height: 12),
                              updateValues(jobLocation, 'Miejsce Praktyk', 1,
                                  28, Icons.place, TextInputType.streetAddress),
                              const SizedBox(height: 16),
                              updateValues(
                                  jobQualification,
                                  'Nazwa Kwalifikacji',
                              ...
                              CheckboxListTile(
                                  ...
                                  title:
                                      Text("Praca Zdalna", style: fontSize16),
                                  value: canRemotely,
                                  dense: true,
                                  controlAffinity:
