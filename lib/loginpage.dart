                  ...
                  child: ConstrainedBox(
                      ...
                      child: Column(children: [
                        ...
                        Visibility(
                            ...
                            child: Text(
                                'Sory Ale Imię I Nazwisko Jest Zbyt Krótkie',
                                style: myErrorFont)),
                        Visibility(
                        ...
                        Visibility(
                            visible:
                                logConstrainsListener.isEmailValidErrorShown,
                            child: Text(
                                'Sory Ale Ten Email Nie Jest Poprawny :<',
                                style: myErrorFont)),
                        const SizedBox(height: 15),
                        logPut(
                            isTextObscured,
                        ...
                        Visibility(
                            ...
                            child: Text(
                                'Sory Ale Jakiś Błąd Się Wkradł W Hasło :<',
                                style: myErrorFont)),
                        Visibility(
